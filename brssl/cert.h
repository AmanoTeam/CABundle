...
static const br_x509_trust_anchor TAs[140] = {
	{
	...
	},
	{
		...
		BR_X509_TA_CA,
		{
			...
			{ .ec = {
				BR_EC_secp384r1,
				(unsigned char *)TA71_EC_Q, sizeof TA71_EC_Q,
			} }
		}
	},
	{
	...
	},
	{
		...
		BR_X509_TA_CA,
		{
			...
			{ .ec = {
				BR_EC_secp384r1,
				(unsigned char *)TA81_EC_Q, sizeof TA81_EC_Q,
			} }
		}
	},
	{
	...
	},
	{
		...
		BR_X509_TA_CA,
		{
			...
			{ .ec = {
				BR_EC_secp384r1,
				(unsigned char *)TA90_EC_Q, sizeof TA90_EC_Q,
			} }
		}
	},
	{
